...
function SheetOverlay({
  ...
  return (
    <SheetPrimitive.Overlay
      ...
      className={cn(
        "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 top-[var(--nav)] z-50",
        className,
      )}
      {...props}
    />
    ...
    <SheetPortal>
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          side === "top" && [
            "data-[state=closed]:slide-out-to-top data-[state=open]:slide-in-from-top inset-x-0 top-[var(--nav)] mt-1 h-[calc(100vh-var(--nav))] border-b",
            "data-[state=closed]:-translate-y-[var(--nav)] data-[state=open]:translate-y-0",
          ],
          side === "bottom" &&
